# NOTE: MANUALLY IMPLEMENTED PUBLIC ENDPOINTS. THIS FILE IS NOT USED IN APPLICATION
# SINCE DJANGO-REST-FRAMEWORK (DRF) NOW TAKES CARE OF THE PUBLIC ENDPOINTS (TO TAKE 
# ADVANTAGE OF ITS INTEGRATION WITH VARIOUS SWAGGER/OPENAPI PACKAGES). THIS FILE HAS 
# BEEN LEFT IN THE PROJECT IN CASE DRF BREAKS ON AN UPDATE. POINT THE API URLCONF TO 
# THESE VIEWS AND COMMENT OUT THE DRF ENDPOINT TO ACHIEVE THE FUNCTIONALITY CURRENTLY 
# HANDLED BY DRF.
