...
def upload_file(file_name, object_name=None):
    ...
    try:
        ...
        logger.warn('Error Occured Uploading File %s To S3 Bucket: "%s"', file_name, aws_creds["bucket"])
...
def download_file(file_name, object_name=None):
    ...
    try:
        ...
        logger.warn('Error Occured Downloading File "%s" From S3 Bucket "%s": %s', file_name, aws_creds["bucket"])